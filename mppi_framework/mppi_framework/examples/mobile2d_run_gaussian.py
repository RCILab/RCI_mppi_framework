...
def main():
    ...
    p.add_argument("--steps", type=int, default=302)
    ...
    ctrl = build_controller(
        ...
        dynamics_cfg={
            "dt": args.dt,
            "angle_wrap": True,
            # device/dtype is already passed by build_controller (avoid duplicates)
        },
