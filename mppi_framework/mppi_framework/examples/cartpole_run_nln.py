...
def main():
    ...
    p.add_argument("--std_init", type=float, default=3.0)
    p.add_argument("--record_sample", type=bool, default=True)
    p.add_argument("--save", type=str, default="outputs/cartpole_nln.gif")
    args = p.parse_args()
    ...
    ctrl = build_controller(
        ...
        sampler_cfg={"std_n": args.std_init,"std_ln":[0.01],"mu_ln": [0.03] ,"device": args.device},
    )
